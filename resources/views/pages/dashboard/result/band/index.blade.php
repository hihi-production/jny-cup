                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('band.champion.create') }}" class="btn btn-primary">Add Champions List</a>
                        </div>
                                    ...
                                    <table class="table table-lg">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $result->place }}</td>
                                                <td>
                                                    <a href="{{ route('band.champion.edit', $result->id) }}" class="btn icon icon left btn-sm btn-warning">
