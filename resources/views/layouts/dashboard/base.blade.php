            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('dashboard/assets/compiled/svg/logo.svg') }}" alt="Logo" srcset=""></a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item {{ Request::route()->getName() == 'dashboard' ? 'active' : null }} ">
                        ...
                        <li
                            class="sidebar-item {{ Request::route()->getName() == 'lomba.index' ? 'active' : null }} ">
                            <a href="{{route('lomba.index')}}" class='sidebar-link'>
                                <i class="bi bi-card-checklist"></i>
                                <span>List of Competitions</span>
                            </a>
                        ...
                        <li
                            ...
                            <i class="bi bi-megaphone"></i>
                                <span>Daily Annnouncements</span>
                            </a>

                        </li>

                        <li
                            class="sidebar-item {{ Request::route()->getName() == 'schedule.index' ? 'active' : null }} ">
